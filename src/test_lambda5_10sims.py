#!/usr/bin/env python
"""
Test lambda=5 on 10 simulations from step 2
"""
import numpy as np
import pandas as pd
import json
...
def main():
    """Test lambda=5 on 10 simulations"""

    logger.info("="*80)
    logger.info("Testing lambda=5 on 10 K=3 simulations")
    logger.info("="*80)
    ...
    sim_files = sorted(sim_dir.glob('sim_T1000_*.parquet'))[:10]
    ...
    # Save results
    output_dir = Path('outputs/test_lambda5')
    output_dir.mkdir(parents=True, exist_ok=True)

    output_file = output_dir / 'results_lambda5_10sims.csv'
    ...
    summary_file = output_dir / 'summary_lambda5_10sims.json'
